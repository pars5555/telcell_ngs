...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div>
            ...
            <div style="background:  url({$SITE_PATH}/img/ajax-loader) no-repeat center; position: fixed;left:0;width:100%;height:100%;top:0;z-index: 1000;display: none" id="ajax-loader"/>
        </div>
